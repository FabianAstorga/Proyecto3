...
let ActividadService = class ActividadService {
    actividadRepository;
    informesService;
    constructor(actividadRepository, informesService) {
    ...
    async crearSimple(dto, usuarioId) {
        if (!dto.fecha) {
    ...
    async crearConFechasEspecificas(dto, usuarioId) {
    ...
    async crearConRepeticionSemanal(dto, usuarioId) {
