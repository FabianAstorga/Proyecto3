...
export declare class ActividadController {
    ...
    create(dto: CreateActividadDto, req: Request): Promise<import("../../database/entities/actividad.entity").Actividad | import("../../database/entities/actividad.entity").Actividad[]>;
    findAll(): Promise<import("../../database/entities/actividad.entity").Actividad[]>;
    findByUser(userId: string): Promise<import("../../database/entities/actividad.entity").Actividad[]>;
