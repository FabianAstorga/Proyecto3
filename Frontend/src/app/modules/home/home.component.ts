...
export class HomeComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  // Usamos las rutas "nuevas" que pusiste tú
  ...
  submit(): void {
    ...
    // Validaciones independientes (como en el viejo)
    if (!email && !password) {
    ...
    this.dataService.login(email, password).subscribe({
      next: (res: any) => {
        ...
        // Guardar token y usuario (según tu AuthService)
