...
class MondayFirstDateAdapter extends NativeDateAdapter {
  override getFirstDayOfWeek(): number { return 1; } // 1 = lunes
}
...
export class ActivitiesHistoryComponent {
  ...
  activities: Activity[] = [
    ...
    { fecha: '2025-10-03', titulo: 'Evaluación Parcial',          detalle: 'Aplicación de prueba a estudiantes',            estado: 'Aprobada',  horas: 6 },
    { fecha: '2025-09-29', titulo: 'Asesoría Académica',          detalle: 'Orientación a estudiantes de primer año',       estado: 'Rechazada', horas: 1 },
    { fecha: '2025-09-22', titulo: 'Charla de Seguridad',         detalle: 'Protocolos en laboratorio',                     estado: 'Aprobada',  horas: 2 },
    { fecha: '2025-09-14', titulo: 'Taller de Programación',      detalle: 'Introducción a Python',                         estado: 'Aprobada',  horas: 4 },
    { fecha: '2025-09-05', titulo: 'Reunión con Dirección',       detalle: 'Planificación semestre',                        estado: 'Pendiente', horas: 1 },
  ];
