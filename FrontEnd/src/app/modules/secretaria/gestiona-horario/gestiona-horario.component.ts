...
export class GestionaHorarioComponent {
  ...
  applyCell() {
    ...
    this.schedule[day][bi] = t ? { title: t, room: this.editorRoom, note: this.editorNote } : null;
    this.selected = null;
  }
  ...
  guardarSemana() {
    console.log('Semana', this.current, 'Horario:', JSON.parse(JSON.stringify(this.schedule)));
